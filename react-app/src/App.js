        ...
        <div id='page_wrap'>
          <Switch>
            ...
            <Route path="/recognition">
              <RecognitionTask images={images[0]} grammar={grammar} options={options} getClass={'panda'}/>
            </Route>
            ...
            <Route path="/grammar">
              <GrammarTask images={images} grammar={grammar} options={options}/>
            </Route>
            <Route path="/click">
              <ClickPointTask images={images[1]} grammar={grammar} options={options}/>
            </Route>
            <Route path="/choose">
              <ChooseImageTask images={images} grammar={grammar} options={options}/>
            </Route>
